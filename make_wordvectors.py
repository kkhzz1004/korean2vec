...
parser.add_argument('--vocab_size', type=int, default=500000, help='the maximum vocabulary size')
...
def make_wordvectors():
    ...
    if  os.path.exists('data/{}.bin'.format(lcode)):
        model = Word2Vec.load('data/{}.bin'.format(lcode))
    else:
